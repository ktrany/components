...
module.exports = (config) => {
  config.set({
    ...
    files: [
      {
        pattern: "node_modules/core-js-bundle/minified.js",
        included: true,
        watched: false,
      },
      {
        pattern: "node_modules/core-js-bundle/minified.js.map",
        included: false,
        watched: false,
      },
      {
      ...
      {
        pattern: "node_modules/systemjs/dist/system.js.map",
        included: false,
        watched: false,
      },
      {
      ...
      {
        pattern: "node_modules/zone.js/dist/proxy.min.js",
        included: true,
        watched: false,
      },
      {
      ...
      {
        pattern: "node_modules/zone.js/dist/jasmine-patch.min.js",
        included: true,
        watched: false,
      },
      {
      ...
      {
        pattern: "node_modules/@material/*/dist/*",
        included: false,
        watched: false,
      },
      ...
      {
        pattern: "dist/karma-system-config.js",
        included: true,
        watched: false,
      },
      ...
      {
        pattern: "tools/system-rxjs-operators.js",
        included: false,
        watched: false,
      },
      ...
      {
        pattern:
          "dist/packages/material-experimental/mdc-theming/prebuilt/indigo-pink.css",
        included: true,
        watched: true,
      },
